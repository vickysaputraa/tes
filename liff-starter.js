...
function getP(){
    ...
    if (!tipe) {
        ...
        document.getElementById('audiox').addEventListener('click', function () {
            liff.sendMessages([{
                type: 'text',
                text: atob('bGluZTovL2FwcC8xNjAyNjg3MzA4LURnZWRHazlBP3R5cGU9YXVkaW8mbGluaz1odHRwczovL3NvdW5kY2xvdWQuY29tL3R3by10aHJlZTA1MDIvc2FuLWhvbG8tb25lLXRoaW5nLXRydW5nLXJlbWl4')
            }]).then(function () {
                liff.closeWindow();
            });
        });
