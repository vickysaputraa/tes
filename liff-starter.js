...
function makeMe(){
    var tipe = getParameterByName('type');
    var prof = liff.getProfile();
    var picts = prof.pictureUrl;
    var names = prof.displayName;
    var stats = prof.statusMessage;
    if (!stats) {
        stats = ' - '
    };
    if (tipe === 'me') {
        liff.sendMessages([{
            ...
            template: {
                ...
                columns: [
                    {
                        thumbnailImageUrl: picts,
                        imageAspectRatio: 'square',
                        imageSize: 'cover',
                        imageBackgroundColor: '#f78888',
                        title: names,
                        text: stats,
                        actions: {
                            type: 'uri',
